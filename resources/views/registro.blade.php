                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h2 text-gray-900 mb-4">¡Alistate capitan!</h1>
                                </div>
                        ...
                        <form class="user" method="post" action="{{route('registro.form')}}">
                            ...
                            <div class="form-group">
                                <input style="font-size: 1.5rem; color: black" type="email" class="form-control form-control-user" id="exampleInputEmail"
                        ...
                        <hr>
                        <div class="text-center">
                            <a  style="color: white; font-size: 1rem" class="small" href="{{route('login')}}">¿Tienes una cuenta? ¡Inicia Sesión!</a>
                        </div>
                    </div>
                </div>
            </div>
